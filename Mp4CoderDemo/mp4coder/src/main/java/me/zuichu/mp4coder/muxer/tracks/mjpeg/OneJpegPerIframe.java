package me.zuichu.mp4coder.muxer.tracks.mjpeg;

import android.graphics.BitmapFactory;

import me.zuichu.mp4coder.boxes.iso14496.part1.objectdescriptors.ESDescriptor;
import me.zuichu.mp4coder.boxes.iso14496.part1.objectdescriptors.ObjectDescriptorFactory;
...
public class OneJpegPerIframe extends AbstractTrack {
    ...
    public OneJpegPerIframe(String name, File[] jpegs, Track alignTo) throws IOException {
        ...
        BitmapFactory.decodeFile(jpegs[0].getPath(), options);
        trackMetaData.setWidth(options.outWidth);
        trackMetaData.setHeight(options.outHeight);
